...
<body>
  ...
  <div class="content">
    <div class="content-info">
      <div class="content-info-title">个人日志详情</div>
      <div class="content-info-main"></div>
      <div class="content-info-video">
        <span>相关视频</span>
        <img id="content-info-video-img" src="{{url('img/head/video.png')}}" style="width:100%; margin:0 auto;" alt="">
      </div>
  ...
  <script type="text/javascript" src="{{url('static/head/js/logdetails.js')}}"></script>
